...
class VendingMachine:
    ...
    def add_funds(self, n):
        ...
        if self.count == 0 :
            ...
            self.balance = 0
            return f'Nothing left to vend. Please restock. Here is your ${temp_balance}.'
    ...
    def vend(self):
        ...
        temp_balance = self.balance - self.price
        self.balance = 0
        self.count = self.count - 1
        if temp_balance == 0:
            return f'Here is your {self.product}.'
        return f'Here is your {self.product} and ${temp_balance} change.'
