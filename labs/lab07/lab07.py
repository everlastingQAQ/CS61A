class Account:
    ...
    def time_to_retire(self, amount):
        ...
        while current < amount :
            current = current + current * Account.interest
            need_year = need_year + 1
        return need_year
...
class FreeChecking(Account):
    ...
    def __init__ (self, account_holder):
        ...
        self.free_counts = FreeChecking.free_withdrawals

    def withdraw(self, amount):
        if self.free_counts >= 1:
            self.free_counts = self.free_counts - 1
...
def without(s, i):
    ...
    def cal(s):
        ...
        if s is Link.empty:
            ...
            return Link(s.first, cal(s.rest))
    return cal(s)
